...
**처리 과정**
1. 현재 브랜치의 변경사항 및 커밋 히스토리 분석
2. `COMMIT_CONVENTION.md` 규칙에 따라 커밋 타입 판단 (feat/fix/refactor/docs/chore)
3. PR 제목 자동 생성 (커밋 메시지 기반)
4. `PULL_REQUEST.md` 템플릿에 맞춰 PR 본문 작성
5. 변경사항을 원격 저장소에 푸시
6. GitHub CLI를 통해 PR 생성
